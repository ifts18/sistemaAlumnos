...
<html lang="es">
  ...
  <body>
  <?php include("ABM_Modal/modal/modal_agregarEquivalencia.php");?>
  <?php include("ABM_Modal/modal/modal_modificarEquivalencia.php");?>
  <?php include("ABM_Modal/modal/modal_eliminarEquivalencia.php");?>
      
    <table width="1000" border="1" align="center" >
      <tbody>
        <tr>
          <td width="604" align="center" ><h1> IFTS18 - Equivalencias Aprobadas por Alumno </h1></td>
    ...
    <div class="container">
                    ...
                    <div class="row">    
                        <div class="col-sm-6">    
                            <button type="button" class="btn btn-success" data-toggle="modal" data-target="#dataRegister"><i class='glyphicon glyphicon-plus'></i> Agregar Materia aprobada por equivalencia</button>
                        </div>    
                        <div class="col-sm-6" >   
	...
	<script src="ABM_Modal/js/appEquivalencia.js"></script>
	<script>
