...
<table width="1000" border="1" align="center">
  <tbody>
    <tr>
      <td width="320" align="center" ><h1> ASIGNATURA </h1></td>
      <td width="320" align="center"><h2><?php print $row_Recordset1['Descripcion'] ?>&nbsp;</h2></td>
    </tr>
  </tbody>
</table>
...
<table width="1103" border="1"align="center">
  <tbody>
    <tr>
      ...
      <td width="200" align="center">Nombre y Apellido</td>
    ...
    do {
        ...
        ?>
            ...
            <td align="center" <h4> <?php echo substr($row_Recordset1['FechaMesa'], 0, 10); ?> </h4></td>
            <td>
            <?php
