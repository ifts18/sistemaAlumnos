            ...
            if(($_POST['Presente'.(string)$row_Recordset2['IdMesaFinalAlumno']])!='0')
                {
                    ...
                    elseif (empty ($par2))
                    {
                       //echo "<script type=\"text/javascript\">alert(\"No puede Guardar Nota Nula\");</script>"; 
                       //exit; 
                       //header("Location: " . "ListarMesasFinales2.php" );
                ...
                {
                    $par3 = $row_Recordset2['IdMesaFinalAlumno'];
                    mysqli_query(dbconnect(),"DELETE FROM terciario.mesa_final_alumno WHERE IdMesaFinalAlumno = $par3");
                }
