...
<div id="productos">
	<?php
		...
		while ($row = mysqli_fetch_array($result)){
                ?>   
                        <tr>
                                            <td width = "10%" align ="center" > <?php echo $row['DNI']; ?></td>
                                            <td width = "10%" align ="center"> <?php echo utf8_decode($row['Apellido']);?></td>
                                            <td width= "10%" align ="center"><?php echo utf8_decode($row['Nombre']); ?></td>
                                            
                                            <td width= "10%" align ="center"> <?php echo $row['FechaCreacion']; ?></td>
                                            <td width= "10%" align ="center"><?php echo $row['Email']; ?></td>
                                            <td width= "10%" align ="center"> <?php echo $row['Password']; ?></td> 
                        </tr>
